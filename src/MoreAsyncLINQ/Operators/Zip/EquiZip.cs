...
static partial class MoreAsyncEnumerable
{
        ...
        Func<T1, T2, TResult> resultSelector)
    {
        ...
        return first.IsKnownEmpty() &&
            ...
            : EquiZipCore<T1, T2, T2, T2, TResult>(
                first,
                second,
                third: null,
                fourth: null,
        ...
        Func<T1, T2, T3, TResult> resultSelector)
    {
        ...
        return first.IsKnownEmpty() &&
               ...
               third.IsKnownEmpty()
            ? AsyncEnumerable.Empty<TResult>()
            : EquiZipCore<T1, T2, T3, T3, TResult>(
                first,
                second,
                third,
                fourth: null,
        ...
        Func<T1, T2, T3, CancellationToken, ValueTask<TResult>> resultSelector)
    {
        ...
        return first.IsKnownEmpty() &&
            ...
            : EquiZipCore<T1, T2, T3, T3, TResult>(
                ...
                third,
                fourth: null,
                (firstElement, secondElement, thirdElement, _, cancellationToken) => resultSelector(firstElement, secondElement, thirdElement, cancellationToken));
    }
