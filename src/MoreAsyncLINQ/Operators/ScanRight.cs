...
static partial class MoreAsyncEnumerable
{
    ...
    /// The specified seed value is used as the initial accumulator value.
    /// This operator is the right-associative version of the
    /// <see cref="MoreAsyncEnumerable.Scan{TSource, TState}(IAsyncEnumerable{TSource}, TState, Func{TState, TSource, CancellationToken, ValueTask{TState}})"/> LINQ operator.
    /// </summary>
    /// <typeparam name="TSource">The type of the elements of source.</typeparam>
    /// <typeparam name="TAccumulate">The type of the accumulator value.</typeparam>
    /// <param name="source">Source sequence.</param>
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        {
            count--;
            accumulator = await func(list[count], accumulator, cancellationToken);
            stack.Push(accumulator);
        }
