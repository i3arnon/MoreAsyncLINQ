...
static partial class MoreAsyncEnumerable
{
    ...
    /// respectively.
    /// </returns>
    public static ValueTask<(IEnumerable<TSource> True, IEnumerable<TSource> False)> PartitionAsync<TSource>(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return source.IsKnownEmpty()
            ? ValueTasks.FromResult((Enumerable.Empty<TSource>(), Enumerable.Empty<TSource>()))
            : source.PartitionAsync(
                predicate,
                static (IEnumerable<TSource> grouping1, IEnumerable<TSource> grouping2) => (grouping1, grouping2),
                cancellationToken);
    }
    ...
    public static ValueTask<TResult> PartitionAsync<TSource, TResult>(
        this IAsyncEnumerable<TSource> source,
        Func<TSource, bool> predicate,
        Func<IEnumerable<TSource>, IEnumerable<TSource>, TResult> resultSelector,
        CancellationToken cancellationToken = default)
    {
        if (source is null) throw new ArgumentNullException(nameof(source));
        if (predicate is null) throw new ArgumentNullException(nameof(predicate));
    ...
    public static ValueTask<TResult> PartitionAsync<TSource, TResult>(
        this IAsyncEnumerable<IGrouping<bool?, TSource>> source,
        Func<IEnumerable<TSource>, IEnumerable<TSource>, IEnumerable<TSource>, TResult> resultSelector,
        CancellationToken cancellationToken = default)
    {
        if (source is null) throw new ArgumentNullException(nameof(source));
        if (resultSelector is null) throw new ArgumentNullException(nameof(resultSelector));
    ...
    private static async ValueTask<TResult> PartitionAsync<TKey, TSource, TResult>(
        ...
        TKey key3,
        IEqualityComparer<TKey>? comparer,
        Func<IEnumerable<TSource>, IEnumerable<TSource>, IEnumerable<TSource>, IEnumerable<IGrouping<TKey, TSource>>, TResult> resultSelector,
        CancellationToken cancellationToken = default)
    {
        Debug.Assert(count is >= 1 and <= 3);
        ...
        var grouping1 = count >= 1 ? null : Enumerable.Empty<TSource>();
        var grouping2 = count >= 2 ? null : Enumerable.Empty<TSource>();
        var grouping3 = count == 3 ? null : Enumerable.Empty<TSource>();
        List<IGrouping<TKey, TSource>>? groupings = null;
        await foreach (var grouping in source.WithCancellation(cancellationToken))
        {
            if (grouping1 is null && comparer.Equals(grouping.Key, key1))
            {
                grouping1 = grouping;
        ...
        return resultSelector(
            ...
            grouping2 ?? [],
            grouping3 ?? [],
            groupings ?? Enumerable.Empty<IGrouping<TKey, TSource>>());
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return source.IsKnownEmpty()
            ...
            : source.PartitionAsync(
                predicate,
                static (grouping1, grouping2, _) => ValueTasks.FromResult((grouping1, grouping2)),
                cancellationToken);
    }
    ...
    public static ValueTask<TResult> PartitionAsync<TSource, TResult>(
        this IAsyncEnumerable<TSource> source,
        Func<TSource, CancellationToken, ValueTask<bool>> predicate,
        Func<IEnumerable<TSource>, IEnumerable<TSource>, CancellationToken, ValueTask<TResult>> resultSelector,
        CancellationToken cancellationToken = default)
    {
        if (source is null) throw new ArgumentNullException(nameof(source));
        if (predicate is null) throw new ArgumentNullException(nameof(predicate));
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return source.PartitionAsync(
            key1: true,
            key2: false,
            (grouping1, grouping2, _, cancellationToken) => resultSelector(grouping1, grouping2, cancellationToken),
            cancellationToken);
    }
    ...
    public static ValueTask<TResult> PartitionAsync<TSource, TResult>(
        this IAsyncEnumerable<IGrouping<bool?, TSource>> source,
        Func<IEnumerable<TSource>, IEnumerable<TSource>, IEnumerable<TSource>, CancellationToken, ValueTask<TResult>> resultSelector,
        CancellationToken cancellationToken = default)
    {
        if (source is null) throw new ArgumentNullException(nameof(source));
        if (resultSelector is null) throw new ArgumentNullException(nameof(resultSelector));
        ...
        return source.PartitionAsync(
            ...
            key2: false,
            key3: null,
            (grouping1, grouping2, grouping3, _, cancellationToken) => resultSelector(grouping1, grouping2, grouping3, cancellationToken),
            cancellationToken);
    }
    ...
    public static ValueTask<TResult> PartitionAsync<TKey, TElement, TResult>(
        this IAsyncEnumerable<IGrouping<TKey, TElement>> source,
        TKey key,
        Func<IEnumerable<TElement>, IEnumerable<IGrouping<TKey, TElement>>, CancellationToken, ValueTask<TResult>> resultSelector,
        CancellationToken cancellationToken = default)
    {
        if (source is null) throw new ArgumentNullException(nameof(source));
        if (resultSelector is null) throw new ArgumentNullException(nameof(resultSelector));
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return PartitionAsync(
            ...
            key,
            comparer,
            (grouping1, _, _, groupings, cancellationToken) => resultSelector(grouping1, groupings, cancellationToken),
            cancellationToken);
    }
    ...
    public static ValueTask<TResult> PartitionAsync<TKey, TElement, TResult>(
        ...
        TKey key1,
        TKey key2,
        Func<IEnumerable<TElement>, IEnumerable<TElement>, IEnumerable<IGrouping<TKey, TElement>>, CancellationToken, ValueTask<TResult>> resultSelector,
        CancellationToken cancellationToken = default)
    {
        if (source is null) throw new ArgumentNullException(nameof(source));
        if (resultSelector is null) throw new ArgumentNullException(nameof(resultSelector));
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return PartitionAsync(
            ...
            key2,
            comparer,
            (grouping1, grouping2, _, groupings, cancellationToken) => resultSelector(grouping1, grouping2, groupings, cancellationToken),
            cancellationToken);
    }
    ...
    public static ValueTask<TResult> PartitionAsync<TKey, TElement, TResult>(
        ...
        TKey key2,
        TKey key3,
        Func<IEnumerable<TElement>, IEnumerable<TElement>, IEnumerable<TElement>, IEnumerable<IGrouping<TKey, TElement>>, CancellationToken, ValueTask<TResult>> resultSelector,
        CancellationToken cancellationToken = default)
    {
        if (source is null) throw new ArgumentNullException(nameof(source));
        if (resultSelector is null) throw new ArgumentNullException(nameof(resultSelector));
    ...
    private static async ValueTask<TResult> PartitionAsync<TKey, TSource, TResult>(
        ...
        TKey key3,
        IEqualityComparer<TKey>? comparer,
        Func<IEnumerable<TSource>, IEnumerable<TSource>, IEnumerable<TSource>, IEnumerable<IGrouping<TKey, TSource>>, CancellationToken, ValueTask<TResult>> resultSelector,
